...
void configureMath() {
	...
	complex_roots[0].real = -1.17041;
	complex_roots[0].imaginary = 0.0;

	complex_roots[1].real = -0.567932;
	complex_roots[1].imaginary = -0.592302;
	
	complex_roots[2].real = -0.567932;
	complex_roots[2].imaginary = 0.592302;

	complex_roots[3].real = 0.809385;
	complex_roots[3].imaginary = 0.371385;

	complex_roots[4].real = 0.809385;
	complex_roots[4].imaginary = -0.371385;
